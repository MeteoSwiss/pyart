...
PyDoc_STRVAR(__pyx_doc_5pyart_7correct_10_unwrap_2d_unwrap_2d, " 2D phase unwrapping. ");
static PyMethodDef __pyx_mdef_5pyart_7correct_10_unwrap_2d_1unwrap_2d = {"unwrap_2d", (PyCFunction)(void*)(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_5pyart_7correct_10_unwrap_2d_1unwrap_2d, __Pyx_METH_FASTCALL|METH_KEYWORDS, __pyx_doc_5pyart_7correct_10_unwrap_2d_unwrap_2d};
static PyObject *__pyx_pw_5pyart_7correct_10_unwrap_2d_1unwrap_2d(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __Pyx_RefNannySetupContext("unwrap_2d (wrapper)", 0);
  {
    ...
    if (__pyx_kwds) {
      ...
      switch (__pyx_nargs) {
        ...
        if (likely((values[1] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_mask)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 4, 4, 1); __PYX_ERR(1, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_unwrapped_image)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 4, 4, 2); __PYX_ERR(1, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_GetKwValue_FASTCALL(__pyx_kwds, __pyx_kwvalues, __pyx_n_s_wrap_around)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 4, 4, 3); __PYX_ERR(1, 18, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        const Py_ssize_t kwd_pos_args = __pyx_nargs;
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values + 0, kwd_pos_args, "unwrap_2d") < 0)) __PYX_ERR(1, 18, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(1, 18, __pyx_L3_error)
    __pyx_v_mask = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_mask.memview)) __PYX_ERR(1, 19, __pyx_L3_error)
    __pyx_v_unwrapped_image = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_unwrapped_image.memview)) __PYX_ERR(1, 20, __pyx_L3_error)
    __pyx_v_wrap_around = values[3];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("unwrap_2d", 1, 4, 4, __pyx_nargs); __PYX_ERR(1, 18, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *              )
 */
  __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_wrap_around, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_3 = __Pyx_PyInt_As_int(__pyx_t_8); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_GetItemInt(__pyx_v_wrap_around, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(1, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_8); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 27, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
 ...
 *               double[:, ::1] unwrapped_image,
 */
  __pyx_t_7 = __Pyx_CyFunction_New(&__pyx_mdef_5pyart_7correct_10_unwrap_2d_1unwrap_2d, 0, __pyx_n_s_unwrap_2d, NULL, __pyx_n_s_pyart_correct__unwrap_2d, __pyx_d, ((PyObject *)__pyx_codeobj__21)); if (unlikely(!__pyx_t_7)) __PYX_ERR(1, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_unwrap_2d, __pyx_t_7) < 0) __PYX_ERR(1, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
