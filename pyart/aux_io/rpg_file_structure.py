...
This is valid only for newer files, after 2018
...
lvl0_header.append({'name':'Header-length',
                    'type':'i',
                    'len':1})
lvl0_header.append({'name':'Start-time',
                    'type':'I',
                    'len':1})
lvl0_header.append({'name':'Stop-time',
                    'type':'I',
                    'len':1})
...
lvl0_header.append({'name':'Max-vel-chirp-seq',
                    'type':'f',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'BW-radar-channel',
                    'type':'f',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Lowest-IF-frequency',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Highest-IF-frequency',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Min-altitude-seq',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Max-altitude-seq',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Ranging-FFT-size',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Nb-invalid-samples',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Chirp-center-freq',
                    'type':'f',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Chirp-BW',
                    'type':'f',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Start-index-FFT',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Stop-index-FFT',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'Nb-FFT-range-layers',
                    'type':'i',
                    'len':[1, 'Nb-chirp-sequences']})
lvl0_header.append({'name':'ADC-sampling-rate',
                    'type':'i',
                    'len': 1})
lvl0_header.append({'name':'Max-unambigous.range',
                    'type':'i',
                    'len': 1}) 
lvl0_header.append({'name':'Flag-pow-level',
                    'type':'B',
                    'len': 1})
lvl0_header.append({'name':'Flag-spike-corr',
                    'type':'B',
                    'len': 1})
lvl0_header.append({'name':'Flag-phase-corr',
                    'type':'B',
                    'len': 1})
lvl0_header.append({'name':'Flag-relpow-corr',
                    'type':'B',
                    'len': 1})
lvl0_header.append({'name':'FFT-window-type',
                    'type':'B',
                    'len': 1})
lvl0_header.append({'name':'ADC-input-range',
                    'type':'H',
                    'len': 1})
lvl0_header.append({'name':'Software-version',
                    'type':'H',
                    'len': 1})
lvl0_header.append({'name':'Noise-filter-threshold-factor',
                    'type':'f',
                    'len': 1})
lvl0_header.append({'name':'Reserved1',
                    'type':'i',
                    'len': 25})
lvl0_header.append({'name':'Reserved2',
                    'type':'I',
                    'len': 10000})
...
lvl1_header.append({'name':'Header-length',
                    'type':'i',
                    'len':1})
lvl1_header.append({'name':'Start-time',
                    'type':'I',
                    'len':1})
lvl1_header.append({'name':'Stop-time',
                    'type':'I',
                    'len':1})
...
lvl1_header.append({'name':'Max-vel-chirp-seq',
                    'type':'f',
                    'len':[1, 'Nb-chirp-sequences']})
lvl1_header.append({'name':'Flag-pow-level',
                    'type':'B',
                    'len': 1})
lvl1_header.append({'name':'Flag-spike-corr',
                    'type':'B',
                    'len': 1})
lvl1_header.append({'name':'Flag-phase-corr',
                    'type':'B',
                    'len': 1})
lvl1_header.append({'name':'Flag-relpow-corr',
                    'type':'B',
                    'len': 1})
lvl1_header.append({'name':'FFT-window-type',
                    'type':'B',
                    'len': 1})
lvl1_header.append({'name':'ADC-input-range',
                    'type':'H',
                    'len': 1})
lvl1_header.append({'name':'Software-version',
                    'type':'H',
                    'len': 1})
lvl1_header.append({'name':'Noise-filter-threshold-factor',
                    'type':'f',
                    'len': 1})
