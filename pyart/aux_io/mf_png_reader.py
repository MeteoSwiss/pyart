...
def read_png(
    ...
    **kwargs,
    ...
    field_dict["data"] = ma_broadcast_to(
        _get_physical_data(
            r_ch, g_ch, b_ch, transparency, field_name=field_name, datatype=datatype
        )[::-1, :],
        (nz, ny, nx),
    )
...
def _get_physical_data(
    r_ch, g_ch, b_ch, transparency, field_name="precipitation_type", datatype="rain"
):
    """
    ...
    if field_name == "precipitation_type":
        ...
        data = np.round(
            r_ch * 299 / 1000 + g_ch * 587 / 1000 + b_ch * 114 / 1000
        ).astype(int)
        ...
        data_ph[
            (r_ch == int("DC", 16)) & (g_ch == int("DC", 16)) & (b_ch == int("DC", 16))
        ] = 1
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("00", 16)) & (b_ch == int("00", 16))
        ] = 2
        data_ph[
            (r_ch == int("CD", 16)) & (g_ch == int("37", 16)) & (b_ch == int("00", 16))
        ] = 3
        data_ph[
            (r_ch == int("FF", 16)) & (g_ch == int("45", 16)) & (b_ch == int("00", 16))
        ] = 4
        data_ph[
            (r_ch == int("FF", 16)) & (g_ch == int("A5", 16)) & (b_ch == int("00", 16))
        ] = 5
        data_ph[
            (r_ch == int("8B", 16)) & (g_ch == int("69", 16)) & (b_ch == int("14", 16))
        ] = 6
        data_ph[
            (r_ch == int("EE", 16)) & (g_ch == int("B4", 16)) & (b_ch == int("22", 16))
        ] = 7
        data_ph[
            (r_ch == int("FF", 16)) & (g_ch == int("D7", 16)) & (b_ch == int("00", 16))
        ] = 8
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("8B", 16)) & (b_ch == int("00", 16))
        ] = 9
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("CD", 16)) & (b_ch == int("00", 16))
        ] = 10
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("FF", 16)) & (b_ch == int("00", 16))
        ] = 11
        data_ph[
            (r_ch == int("9A", 16)) & (g_ch == int("CD", 16)) & (b_ch == int("32", 16))
        ] = 12
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("FF", 16)) & (b_ch == int("FF", 16))
        ] = 13
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("CD", 16)) & (b_ch == int("CD", 16))
        ] = 14
        data_ph[
            (r_ch == int("48", 16)) & (g_ch == int("76", 16)) & (b_ch == int("FF", 16))
        ] = 15

        # used in fuzzy logic clutter detection:
        data_ph[
            (r_ch == int("3A", 16)) & (g_ch == int("5F", 16)) & (b_ch == int("CD", 16))
        ] = 8

        data_ph = np.ma.masked_where(
            (r_ch == int("FF", 16)) & (g_ch == int("FF", 16)) & (b_ch == int("FF", 16)),
            data_ph,
        )  # noise
        ...
        data_ph[
            (r_ch == int("28", 16)) & (g_ch == int("00", 16)) & (b_ch == int("50", 16))
        ] = (4 / 100)
        data_ph[
            (r_ch == int("24", 16)) & (g_ch == int("00", 16)) & (b_ch == int("64", 16))
        ] = (8 / 100)
        data_ph[
            (r_ch == int("20", 16)) & (g_ch == int("00", 16)) & (b_ch == int("78", 16))
        ] = (11 / 100)
        data_ph[
            (r_ch == int("1C", 16)) & (g_ch == int("00", 16)) & (b_ch == int("8C", 16))
        ] = (15 / 100)
        data_ph[
            (r_ch == int("18", 16)) & (g_ch == int("00", 16)) & (b_ch == int("A0", 16))
        ] = (19 / 100)
        data_ph[
            (r_ch == int("20", 16)) & (g_ch == int("10", 16)) & (b_ch == int("B8", 16))
        ] = (23 / 100)
        data_ph[
            (r_ch == int("2C", 16)) & (g_ch == int("20", 16)) & (b_ch == int("D0", 16))
        ] = (26 / 100)
        data_ph[
            (r_ch == int("34", 16)) & (g_ch == int("30", 16)) & (b_ch == int("E8", 16))
        ] = (30 / 100)
        data_ph[
            (r_ch == int("40", 16)) & (g_ch == int("40", 16)) & (b_ch == int("FC", 16))
        ] = (34 / 100)
        data_ph[
            (r_ch == int("30", 16)) & (g_ch == int("5C", 16)) & (b_ch == int("E8", 16))
        ] = (38 / 100)
        data_ph[
            (r_ch == int("20", 16)) & (g_ch == int("78", 16)) & (b_ch == int("D4", 16))
        ] = (42 / 100)
        data_ph[
            (r_ch == int("10", 16)) & (g_ch == int("94", 16)) & (b_ch == int("C0", 16))
        ] = (45 / 100)
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("AC", 16)) & (b_ch == int("AC", 16))
        ] = (49 / 100)
        data_ph[
            (r_ch == int("20", 16)) & (g_ch == int("C0", 16)) & (b_ch == int("C0", 16))
        ] = (53 / 100)
        data_ph[
            (r_ch == int("40", 16)) & (g_ch == int("D4", 16)) & (b_ch == int("D4", 16))
        ] = (57 / 100)
        data_ph[
            (r_ch == int("60", 16)) & (g_ch == int("E8", 16)) & (b_ch == int("E8", 16))
        ] = (60 / 100)
        data_ph[
            (r_ch == int("80", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("FC", 16))
        ] = (64 / 100)
        data_ph[
            (r_ch == int("80", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("C0", 16))
        ] = (68 / 100)
        data_ph[
            (r_ch == int("80", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("80", 16))
        ] = (72 / 100)
        data_ph[
            (r_ch == int("80", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("40", 16))
        ] = (75 / 100)
        data_ph[
            (r_ch == int("80", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("00", 16))
        ] = (79 / 100)
        data_ph[
            (r_ch == int("94", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("14", 16))
        ] = (83 / 100)
        data_ph[
            (r_ch == int("A8", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("28", 16))
        ] = (87 / 100)
        data_ph[
            (r_ch == int("BC", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("3C", 16))
        ] = (91 / 100)
        data_ph[
            (r_ch == int("CC", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("50", 16))
        ] = (94 / 100)
        data_ph[
            (r_ch == int("D8", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("3C", 16))
        ] = (98 / 100)
        data_ph[
            (r_ch == int("E4", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("28", 16))
        ] = (102 / 100)
        data_ph[
            (r_ch == int("F0", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("14", 16))
        ] = (106 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("FC", 16)) & (b_ch == int("00", 16))
        ] = (109 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("F0", 16)) & (b_ch == int("10", 16))
        ] = (113 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("DC", 16)) & (b_ch == int("20", 16))
        ] = (117 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("CC", 16)) & (b_ch == int("30", 16))
        ] = (121 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("B4", 16)) & (b_ch == int("44", 16))
        ] = (125 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("A8", 16)) & (b_ch == int("30", 16))
        ] = (128 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("98", 16)) & (b_ch == int("20", 16))
        ] = (132 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("8C", 16)) & (b_ch == int("10", 16))
        ] = (136 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("7C", 16)) & (b_ch == int("00", 16))
        ] = (140 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("74", 16)) & (b_ch == int("00", 16))
        ] = (143 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("6C", 16)) & (b_ch == int("00", 16))
        ] = (147 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("5C", 16)) & (b_ch == int("00", 16))
        ] = (151 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("50", 16)) & (b_ch == int("00", 16))
        ] = (155 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("58", 16)) & (b_ch == int("1C", 16))
        ] = (158 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("60", 16)) & (b_ch == int("3C", 16))
        ] = (162 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("68", 16)) & (b_ch == int("58", 16))
        ] = (166 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("74", 16)) & (b_ch == int("74", 16))
        ] = (170 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("58", 16)) & (b_ch == int("58", 16))
        ] = (174 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("3C", 16)) & (b_ch == int("3C", 16))
        ] = (177 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("1C", 16)) & (b_ch == int("1C", 16))
        ] = (181 / 100)
        data_ph[
            (r_ch == int("FC", 16)) & (g_ch == int("00", 16)) & (b_ch == int("00", 16))
        ] = (185 / 100)
        data_ph[
            (r_ch == int("EC", 16)) & (g_ch == int("00", 16)) & (b_ch == int("2C", 16))
        ] = (189 / 100)
        data_ph[
            (r_ch == int("D8", 16)) & (g_ch == int("00", 16)) & (b_ch == int("5C", 16))
        ] = (192 / 100)
        data_ph[
            (r_ch == int("C8", 16)) & (g_ch == int("00", 16)) & (b_ch == int("88", 16))
        ] = (196 / 100)
        data_ph[
            (r_ch == int("B4", 16)) & (g_ch == int("00", 16)) & (b_ch == int("B4", 16))
        ] = (200 / 100)
        data_ph[
            (r_ch == int("00", 16)) & (g_ch == int("00", 16)) & (b_ch == int("00", 16))
        ] = (10000 / 100)
        ...
        data_ph = np.ma.masked_where(
            (r_ch == int("BC", 16)) & (g_ch == int("BC", 16)) & (b_ch == int("BC", 16)),
            data_ph,
        )  # no measurement
        ...
        warn(f"Unknown scale for field {field_name}." f" Returning gray scale values")
        data = np.round(
            r_ch * 299 / 1000 + g_ch * 587 / 1000 + b_ch * 114 / 1000
        ).astype(int)
        data_ph = deepcopy(data)
