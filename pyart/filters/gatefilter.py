...
def snr_based_gate_filter(radar, snr_field=None, min_snr=10.0, max_snr=None):
    """
    ...
    if (min_snr is not None or max_snr is not None) and (snr_field in radar_aux.fields):
...
def visibility_based_gate_filter(radar, vis_field=None, min_vis=10.0):
    """
