...
from ..util.datetime_utils import datetime_from_radar, make_utc_aware
...
def _update_qvp_metadata(qvp, ref_time, lon, lat, elev=90.0):
    ...
    """
    start_time = make_utc_aware(num2date(0, qvp.time["units"], qvp.time["calendar"]))
