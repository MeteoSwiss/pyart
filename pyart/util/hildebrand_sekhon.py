...
def estimate_noise_hs74_old(spectrum, navg=1, nnoise_min=1):
    """
...
#    start_time = time.time()
    ...
    for npts in range(nnoise_min, len(sorted_spectrum)+1):
...
#    # debugging
#    print(" noise estimation takes %s seconds " %
